...
import { classNames, FormatTime, requestHandler, ToastService } from "../../utils";
      ...
      >
        ...
        <div className="flex justify-center items-center flex-shrink-0">
          {chat.isGroupChat ? (
            ...
            <img
              src={chat.user.avatar || "https://ui-avatars.com/api/?name=John+Doe"}
        ...
        <div className="w-full">
          <p className="truncate-1">
            ...
            {chat.isGroupChat ? chat.name : chat.user.name}
          </p>
        ...
        <div className="flex text-white/50 h-full text-sm flex-col justify-between items-end">
          <small className="mb-2 inline-flex flex-shrink-0 w-max">
            {FormatTime.getTime(chat.lastMessageTime || chat.createdAt)}{" "}
            ago
          </small>
